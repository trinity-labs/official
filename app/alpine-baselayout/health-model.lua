...
mymodule.get_system = function (self)
	...
	system.boardName = cfe({ value=querycmd("cat /sys/devices/virtual/dmi/id/board_name") or "", label="Board Name" })
	system.boardVendor = cfe({ value=querycmd("cat /sys/devices/virtual/dmi/id/board_vendor") or "", label="Board Vendor" })
	system.boardVersion = cfe({ value=querycmd("cat /sys/devices/virtual/dmi/id/board_version") or "", label="Board Version" })
	system.biosVendor = cfe({ value=querycmd("cat /sys/devices/virtual/dmi/id/bios_vendor") or "", label="Bios Vendor" })
	system.biosVersion = cfe({ value=querycmd("cat /sys/devices/virtual/dmi/id/bios_version") or "", label="Bios Version" })
	system.biosDate = cfe({ value=querycmd("cat /sys/devices/virtual/dmi/id/bios_date") or "", label="Bios Date" })
...
mymodule.get_proc = function (self)
	...
	proc.temp = cfe({ value=querycmd("cat /sys/class/thermal/thermal_zone2/temp") or "", label="CPU Temp" })
